...
return
    ...
    [
         ...
         */
        'serviceEmail' => 'ttt-analytics-api@imperial-rarity-123907.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('TTT-Analytics-b69677526224.p12'),
